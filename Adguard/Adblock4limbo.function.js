...
function navigation4limbo_body_pre() {
    ...
    let ele_innerHTML = '\
        ...
        <li class="li_global"><button style="border-radius:4px; background:#5165e4 !important; box-shadow:inset 0px 0px 15px 3px #16191f00;" class="a_global red"  id="play" onclick="window.player.play()">播放! 🎵</button></li>\
