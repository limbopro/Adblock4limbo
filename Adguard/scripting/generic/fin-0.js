...
const genericExceptionSieve = [2026265,16153475,12341963,8251810,324316,7954035,4538141,6039851,2872095,5406194,1647817,2616067,7105871];
const genericExceptionMap = [["hardware.fi",".top-ad-space"],["murha.info",".adsbygoogle\n.adsbox"],["iltalehti.fi",".ad-placement"],["danskebank.fi",".app-banner:not(html, body)"],["classic.nettiauto.com","#adv"],["www.nettiauto.com","#adv"],["anna.fi",".sponsored-content"],["kaksplus.fi",".sponsored-content"],["hs.fi",".mainokset\n.mainos"],["sokos.fi",".mainokset"],["tilannehuone.fi",".mainos"],["pienimatkaopas.com","#mainos"],["netticaravan.fi","article.ad"],["www.seurakuntalainen.fi","#CookieBanner"],["srk.fi","#CookielawBanner"]];
