...
const argsList = [["simple-funnel-name",""],["social-qa/telemetry",""],["plus-sheet-session-count","0"],["payed","2"]];

const hostnamesMap = new Map([["brainly.co.id",0],["brainly.com",1],["dtf.ru",2],["fontshub.pro",3]]);
