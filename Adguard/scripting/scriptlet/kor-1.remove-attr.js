...
const argsList = [["placeholder","#webzineHeadmenuF1 input[placeholder][autocomplete=\"off\"]"],["placeholder","input#searchMainKeyword"],["placeholder","input#searchKeyword"],["placeholder","input.search_input","asap stay"]];

const hostnamesMap = new Map([["inven.co.kr",0],["kyobobook.co.kr",[1,2]],["pping.kr",3]]);
