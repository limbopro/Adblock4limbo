...
const argsList = [["dfpConfig","loadAds"],["adblockDetector"],["AdsReloadConfig"],["EventTarget.prototype.addEventListener","window.TextDecoder"]];

const hostnamesMap = new Map([["gamer.no",0],["tu.no",0],["tv2.no",1],["bold.dk",3]]);

const entitiesMap = new Map([["gamereactor",2]]);
