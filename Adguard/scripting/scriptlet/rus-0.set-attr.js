...
const argsList = [["#progress-value","data-timer","10"],[".Root:not(.sgia-main-content) main > div:first-child:empty","class","false"],["a[href$=\"?ref=recommended\"]","target",""],["main > div:first-child:empty","class","false"]];

const hostnamesMap = new Map([["howdyho.net",0],["sdamgia.ru",1],["dtf.ru",2],["vc.ru",2],["reshu.by",3]]);
