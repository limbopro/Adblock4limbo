...
const argsList = [["JSON.stringify","contentPlaybackContext\":{","contentPlaybackContext\":{\"isInlinePlaybackNoAd\":true,","condition","contentPlaybackContext"],["atob",".length === 0",".length === 31"],["atob","window.matchMedia('(display-mode: standalone)').matches","true"],["decodeURIComponent","Math.random() <= 0.15","false"],["Array.prototype.shift","/^.+$/s","","condition","https"],["atob","skmedix.com","skmedix.pl"]];
