...
<script type="text/javascript" src="https://limbopro.com/Adguard/Adblock4limbo.user.js"></script>'
...
if (url.indexOf("missav") != -1) {
    ...
    let window_open_str = '';
    let reg = '<head>';
    let str = '<head><link rel="stylesheet" href="https://limbopro.com/CSS/contentFarm.css" type="text/css"/> <script type="text/javascript" async="async" src="https://limbopro.com/Adguard/contentFarm_test.js"></script>'
