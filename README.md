...
✅ **效用**：毒奶去广告计划（稳定版）For QuantumultX），仅针对iOS浏览器（Chrome/Safari等）网页广告（弹窗横幅等），如Pornhub，奈菲影视，低端影视、真不卡等，提升观影或网页浏览体验；本计划会长期更新，以适应未来更多需要；如需反馈问题请加入我们的电报讨论组或提交issue；
...
毒奶去广告计划之 **去广告列表最后更新时间**：02.20.2021 ，请及时更新分流和重写；
